...
const calculateStart=text.indexOf('      function calculate() {');
if(calculateStart===-1){ console.error('Could not find calculate()'); process.exit(1); }
text=text.slice(0,calculateStart)+newFunctions+text.slice(calculateStart);

// Insert dispatch cases before default branch
...
console.log('Injected JS dispatch safely');
