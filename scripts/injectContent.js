const fs=require('fs');
const path='src/config/calculatorContent.ts';
let text=fs.readFileSync(path,'utf8');

const additions=`
  "hong-kong-salaries-tax-salary-tax-computation": {
    "howToUse": { "title": "How to Use", "html": "<p>Use this Hong Kong Salary Tax Computation tool to get a detailed breakdown of your salaries tax. Enter your income, MPF contributions, marital status, and number of children.</p>" },
    ...
    "formula": { "title": "Formula", "html": "<p>Salaries Tax = min(progressive tax, standard rate x net chargeable income). Progressive rates: 2% on first $50k, 6% next $50k, 10% next $50k, 14% next $50k, 17% remainder.</p>" },
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>Progressive: 2% / 6% / 10% / 14% / 17%. Standard: 15% on net chargeable income.</p>" },
    "commonMistakes": { "title": "Common Mistakes", "html": "<ul class=\\"list-disc pl-6 space-y-2\\"><li>Forgetting to include MPF contributions.</li><li>Using incorrect marital status for allowances.</li></ul>" },
  ...
  "hong-kong-salaries-tax-hk-net-salary-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate your take-home pay after tax and MPF in Hong Kong. Enter your income and contributions.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Take-Home Pay:</strong> Income after salaries tax and MPF contributions.</p>" },
  ...
  "hong-kong-salaries-tax-hong-kong-tax-calculator-for-expats": {
    "howToUse": { "title": "How to Use", "html": "<p>Estimate your Hong Kong tax as a foreign employee or expat. Enter your Hong Kong-sourced income and allowances.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Salaries Tax:</strong> Only Hong Kong-sourced income is taxable for expats.</p>" },
    "formula": { "title": "Formula", "html": "<p>Same progressive/standard calculation. Only HK-sourced income is taxable.</p>" },
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>Progressive: 2% / 6% / 10% / 14% / 17%. Standard: 15%.</p>" },
    "commonMistakes": { "title": "Common Mistakes", "html": "<ul class=\\"list-disc pl-6 space-y-2\\"><li>Including overseas income.</li><li>Ignoring the 60-day rule.</li></ul>" },
    "relatedCalculators": { "title": "Related Calculators", "html": "<a href=\\"/countries/hong-kong/salaries-tax/salaries-tax-calculator\\">Salaries Tax Calculator</a>" },
  ...
  "hong-kong-salaries-tax-hong-kong-income-tax-for-foreigners-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate income tax for foreigners working in Hong Kong. Enter assessable income and deductions.</p>" },
  ...
  "hong-kong-profits-tax-hk-corporate-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate corporate tax for Hong Kong limited companies. Enter profits and business type.</p>" },
    ...
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>Two-tiered rates for corporations: 8.25% on first $2M, remainder 16.5%.</p>" },
    ...
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.ird.gov.hk\\">Hong Kong IRD</a>" },
    "faqSchema": { "What is the corporate tax rate in Hong Kong?":"Corporations pay 16.5%. Unincorporated businesses pay 15%. Only HK-sourced profits are taxable." }
  },
  "hong-kong-profits-tax-profit-tax-computation": {
    "howToUse": { "title": "How to Use", "html": "<p>Get a detailed breakdown of your Hong Kong profit tax computation. Enter assessable profits and business type.</p>" },
    ...
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>Two-tiered: 8.25% on first $2M, remainder 16.5% for corporations.</p>" },
  ...
  "hong-kong-stamp-duty-hk-property-stamp-duty-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate Hong Kong property stamp duty including AVD and BSD. Enter the property price and buyer type.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Stamp Duty:</strong> Based on Scale 2 rates depending on buyer and property type.</p>" },
    "formula": { "title": "Formula", "html": "<p>Scale 2 rates: Flat $100 up to $4M, then progressive up to 4.25%.</p>" },
    ...
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.ird.gov.hk\\">Hong Kong IRD</a>" },
    "faqSchema": { "What is stamp duty on residential property in Hong Kong?":"Scale 2 rates apply: flat $100 up to $4M, then progressive rates up to 4.25%." }
  },
  "hong-kong-stamp-duty-stamp-duty-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Estimate stamp duty for Hong Kong property purchases. Enter price, buyer type, and property type.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Stamp Duty:</strong> Based on Scale 2. <strong>Total Cost:</strong> Price plus taxes.</p>" },
    ...
    "suggestedArticles": { "title": "Suggested Articles", "html": "<a href=\\"/blogs/hong-kong-stamp-duty-guide\\">Stamp Duty Guide</a>" },
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.ird.gov.hk\\">Hong Kong IRD</a>" },
    "faqSchema": { "How is HK stamp duty calculated?":"It is calculated using Scale 2 rates based on the property's purchase price." }
  },
  "hong-kong-stamp-duty-rental-stamp-duty-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate stamp duty on rental agreements and leases in Hong Kong. Enter total rent and lease term.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Stamp Duty:</strong> Fixed amount based on lease term.</p>" },
    "formula": { "title": "Formula", "html": "<p>Lease stamp duty is a fixed amount: $5 for ≤1 year, $10 for 1-3 years, $20 for >3 years.</p>" },
  ...
  "hong-kong-stamp-duty-first-registration-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate first registration tax for Hong Kong vehicles. Enter vehicle value, fuel type, and vehicle type.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>First Registration Tax:</strong> One-time tax on vehicle first registration. Electric vehicles may qualify for exemptions.</p>" },
    "formula": { "title": "Formula", "html": "<p>FRT is tiered by vehicle value. Passenger cars have the highest rates. EVs may receive full or partial waivers.</p>" },
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>Tiered by value and fuel type. EVs enjoy significant concessions.</p>" },
    "commonMistakes": { "title": "Common Mistakes", "html": "<ul class=\\"list-disc pl-6 space-y-2\\"><li>Using petrol rates for EVs.</li><li>Forgetting updated concession caps.</li></ul>" },
    "relatedCalculators": { "title": "Related Calculators", "html": "<a href=\\"/countries/hong-kong/stamp-duty/stamp-duty-calculator\\">Stamp Duty Calculator</a>" },
    ...
    "faqSchema": { "Is there a First Registration Tax exemption for electric vehicles?":"Yes, EVs enjoy full or partial FRT waiver subject to latest caps." }
  },
  "hong-kong-property-tax-property-tax-calculator": {
    ...
    "formula": { "title": "Formula", "html": "<p>NAV = Gross - 20% standard deduction - irrecoverable rent. Tax = NAV x 15%.</p>" },
  ...
  "hong-kong-property-tax-hk-rental-tax-deduction-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Estimate rental tax deductions and property tax liability. Enter gross rental income and irrecoverable rent.</p>" },
  ...
  "united-states-payroll-tax-fica-calculator": {
    ...
    "formula": { "title": "Formula", "html": "<p>SS = min(income, wage base) x 6.2%. Medicare = income x 1.45%.</p>" },
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>SS wage base: $176,100 (2025). Additional Medicare: 0.9% over $200k.</p>" },
  ...
  "united-states-payroll-tax-self-employment-tax": {
    "howToUse": { "title": "How to Use", "html": "<p>Estimate SE tax for freelancers and independent contractors. Enter your net self-employment income.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>SE Tax:</strong> 15.3% of 92.35% of net earnings. <strong>Deductible:</strong> 50% of SE tax.</p>" },
    ...
    "commonMistakes": { "title": "Common Mistakes", "html": "<ul class=\\"list-disc pl-6 space-y-2\\"><li>Using gross instead of 92.35% adjusted income.</li></ul>" },
    "relatedCalculators": { "title": "Related Calculators", "html": "<a href=\\"/countries/united-states/payroll-tax/payroll-tax-calculator\\">Payroll Tax Calculator</a>" },
    "suggestedArticles": { "title": "Suggested Articles", "html": "<a href=\\"/countries/united-states/payroll-tax\\">Payroll Tax Guide</a>" },
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.irs.gov\\">IRS</a>" },
  ...
  "united-states-corporate-tax-small-business-tax": {
    "howToUse": { "title": "How to Use", "html": "<p>Estimate taxes for pass-through business entities. Enter taxable income and entity type.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Corporate Tax:</strong> 0% for pass-through (income passes to owners).</p>" },
    ...
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.irs.gov\\">IRS</a>" },
    "faqSchema": { "Do small businesses pay corporate tax?":"Pass-through entities do not pay entity-level tax. C-Corps pay 21%." }
  },
  "united-states-capital-gains-tax-ltcg-calculator": {
    ...
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.irs.gov\\">IRS</a>" },
    "faqSchema": { "What is long-term capital gains tax?":"Gains on assets held >1 year taxed at 0%, 15%, or 20% based on income." }
  },
  "pakistan-income-tax-salary-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate your Pakistan income tax on salary. Enter annual salary and employment type.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Income Tax:</strong> Progressive FBR slabs. <strong>Effective Rate:</strong> Tax / gross.</p>" },
  ...
  "pakistan-income-tax-business-income-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate income tax for business and freelancers in Pakistan. Enter annual business income.</p>" },
  ...
  "pakistan-income-tax-capital-gain-tax-calculator": {
    ...
    "commonMistakes": { "title": "Common Mistakes", "html": "<ul class=\\"list-disc pl-6 space-y-2\\"><li>Applying wrong rate for asset type.</li></ul>" },
  ...
  "pakistan-property-tax-token-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate token tax for property and vehicle registration. Select token type and enter details.</p>" },
    "understandingResults": { "title": "Understanding Results", "html": "<p><strong>Token Tax:</strong> Fixed fee based on token type.</p>" },
    "formula": { "title": "Formula", "html": "<p>Vehicle token based on engine capacity. Flat PKR 50-$500.</p>" },
  ...
  "pakistan-property-tax-rental-income-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate tax on rental income from property in Pakistan. Enter rent and expenses.</p>" },
    ...
    "suggestedArticles": { "title": "Suggested Articles", "html": "<a href=\\"/countries/pakistan/property-tax\\">Property Tax Guide</a>" },
    "officialResources": { "title": "Official Resources", "html": "<a href=\\"https://www.fbr.gov.pk\\">FBR Pakistan</a>" },
    "faqSchema": { "Is rental income taxable in Pakistan?":"Yes, net rental income is taxed at individual slab rates." }
  },
  "pakistan-vehicle-tax-vehicle-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate vehicle token tax in Pakistan by province. Enter engine capacity.</p>" },
  ...
  "pakistan-vehicle-tax-sindh-vehicle-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate Sindh vehicle token tax and transfer fees. Enter engine capacity and vehicle age.</p>" },
  ...
  "pakistan-vehicle-tax-islamabad-vehicle-tax-calculator": {
    "howToUse": { "title": "How to Use", "html": "<p>Calculate Islamabad vehicle token tax. Enter engine capacity and vehicle type.</p>" },
  ...
  "united-states-income-tax-effective-tax-rate": {
    ...
    "taxSlabs": { "title": "Tax Slabs", "html": "<p>N/A - this is a summary calculator.</p>" },
...
if(lastBrace===-1){ console.error('Could not find closing };'); process.exit(1); }
text=text.slice(0,lastBrace)+additions+'\n'+text.slice(lastBrace);
fs.writeFileSync(path,text);
console.log('Appended calculatorContent entries');
